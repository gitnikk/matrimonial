  ...
  <div class="collapse navbar-collapse" id="navbarSupportedContent">
    <ul class="navbar-nav ml-auto">        
        ...
        <li class="nav-item dropdown">
            ...
            <a class="dropdown-item" href="contact-requests.php">रिक्वेस्टेड प्रोफाइल्स</a>
