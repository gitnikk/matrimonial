                    ...
                    <div class="ts-box mb-0 p-5 ts-mt__n-10">
                        <div class="row">
                            ...
                            <div class="col-md-8">
                                ...
                                <form id="form-contact" method="post" class="clearfix ts-form ts-form-email ts-inputs__transparent" action="sendEmail.php">
                                    <input type="hidden" id="subject" name="subject" value="milap visitor's message" />
                                    <div class="row">
