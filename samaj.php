<?php 
    ...
    if(!isset($_REQUEST["id"])){
        $_SESSION["user_samaj_id"] = "1";    
    } else{
        $_SESSION["user_samaj_id"] = $_REQUEST["id"];
    }
...
<?php
    ...
    // Get Samaj
    $sqlSamaj = "select * from samaj where id = $_SESSION[user_samaj_id] and isDeleted = 0";
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="card" data-animate="ts-fadeInUp" >
                                            ...
                                            <div class="card-footer bg-white text-center">
                                                <a onclick="setGenderInSession('male')" class="btn btn-primary">सर्च करा</a>
                                                <!--  href="search.php?g=m" -->
                                            </div>
                                        </div>
                                        <!--end card-->
                                    ...
                                    <div class="col-md-6">
                                        <div class="card" data-animate="ts-fadeInUp" >
                                            ...
                                            <div class="card-footer bg-white text-center">
                                                <a onclick="setGenderInSession('female')"  class="btn btn-primary">सर्च करा</a>
                                                <!-- href="search.php?g=f" -->
                                            </div>
                                        </div>
                                        <!--end card-->
...
<?php
    $sqlSponsors = "SELECT * FROM sponsors 
                    WHERE samajId = $_SESSION[user_samaj_id] and isDeleted = 0 and isVisible = 1";
...
?>
    ...
    <script>
        function setGenderInSession(gender){
            $.post("ajax.php", {action: "setGenderInSession", gender: ""+gender}, function(result){
